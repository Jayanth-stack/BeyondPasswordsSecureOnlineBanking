...
class LoginShapedSessionGateTests(unittest.TestCase):
    ...
    def test_deny_request_login_session_uses_session_userid(self):
        self._login_shaped()
    ...
    def test_approve_request_login_session_uses_session_userid(self):
        self._login_shaped()
        with patch("app.Employee") as emp_cls, patch("app.Customers") as customers_cls:
            ...
            emp_cls.return_value.get_fromAccount_of_transaction.return_value = 1
            emp_cls.return_value.get_toAccount_of_transaction.return_value = 2
