...
from utility.wire import MemoryWireStore, set_service as set_wire_service
...
class WireAppWiringTests(unittest.TestCase):
    ...
    def test_get_customer_includes_wires_for_staff(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertEqual(
            response.get_json()["Wires"]["beneficiaries"][0]["nickname"], "Chase"
        )

    def test_claimed_admin_session_can_add_for_another_customer(self):
