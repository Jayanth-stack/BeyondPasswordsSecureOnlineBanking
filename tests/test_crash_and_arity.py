...
class CrashAndArityRouteTests(unittest.TestCase):
    ...
    def test_deactivate_account_authorized_forwards_actor_and_account(self):
    ...
    def test_deactivate_customer_authorized_forwards_actor_and_customer(self):
        self._session("emp1", "tier2", emp_tier=2)
        with patch("app.Employee") as emp_cls:
    ...
    def test_approve_update_info_authorized_forwards_actor_and_req(self):
    ...
    def test_reset_password_approved_otp_uses_force_reset(self):
        ...
        ) as reset_f, patch("app.twilio_client") as twilio:
        ...
        self.assertEqual(response.status_code, 200)
        reset_f.assert_called_once_with("emp1", "n3w")
